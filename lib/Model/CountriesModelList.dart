...
/// tests : 1317347
/// testsPerOneMillion : 32324
/// population : 40754388
/// continent : "Asia"
/// oneCasePerPeople : 180
/// oneDeathPerPeople : 5125
/// oneTestPerPeople : 31
/// activePerOneMillion : 292.36
/// recoveredPerOneMillion : 5082.99
/// criticalPerOneMillion : 0

class CountriesModelList {
  CountriesModelList({
      num? updated, 
      String? country, 
  ...
  CountriesModelList.fromJson(dynamic json) {
...
CountriesModelList copyWith({  num? updated,
  String? country,
  CountryInfo? countryInfo,
  num? cases,
  num? todayCases,
  ...
  num? recoveredPerOneMillion,
  num? criticalPerOneMillion,
}) => CountriesModelList(  updated: updated ?? _updated,
